...
class WebExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('category_level_choices', array($this, 'getLevelCategoryChoices')),
    ...
    public function getLevelCategoryChoices($groupName, $indent = '　',$level=1)
    {
        $builder = new CategoryBuilder();
        return $builder->buildChoices($groupName, $indent,'travel',$level);
    }
