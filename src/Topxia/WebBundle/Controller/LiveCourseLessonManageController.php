...
//            ));
            ...
            $StreamName=md5($liveLesson['courseId'].time());
...
//            }
            ...
            $liveLesson['mediaId']      = $StreamName;
            $liveLesson['liveProvider'] = $StreamName;

//            var_dump($liveLesson);exit;
    ...
    public function editAction(Request $request, $courseId, $lessonId)
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            $liveLesson['qrcode']    = empty($editLiveLesson['qrcode']) ? null : $editLiveLesson['qrcode'];
