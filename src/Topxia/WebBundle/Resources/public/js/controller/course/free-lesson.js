define(function(require, exports, module) {
    ...
    exports.run = function() {
		...
		if ($("#lesson-preview-swf-player").length > 0) {
			swfobject.embedSWF($("#lesson-preview-swf-player").data('url'), 'lesson-preview-swf-player', '810', '456', "9.0.0", null, null, {wmode: 'transparent'});
        ...
        if ($("#lesson-preview-iframe").length > 0) {
            ...
            var html = '<iframe src="' + $("#lesson-preview-iframe").data('url') + '" style="height:456; width:810; border:0px;" scrolling="no"></iframe>';
