define(function(require, exports, module) {
    ...
    exports.run = function() {
        ...
        var now = new Date();
        $("[name=travelStartTime]").datetimepicker({
            format: 'yyyy-mm-dd',
            minView: "month",
            language: 'zh-CN',
            autoclose:true
        ...
        $('[name=travelStartTime]').datetimepicker('setStartDate', now);
        $("[name=travelEndTime]").datetimepicker({
            format: 'yyyy-mm-dd',
            minView: "month",
            language: 'zh-CN',
            autoclose:true
        ...
        $('[name=travelEndTime]').datetimepicker('setStartDate', now);
